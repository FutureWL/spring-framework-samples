<%--@elvariable id="searchForm" type="MainController.SearchForm"--%>
<%--@elvariable id="searchPerformed" type="boolean"--%>
<%--@elvariable id="results" type="org.springframework.data.domain.Page<SearchResult<io.github.futurewl.site.entities.ForumPost>>"--%>
<!DOCTYPE html>
<html>
<head>
    <title>Search</title>
