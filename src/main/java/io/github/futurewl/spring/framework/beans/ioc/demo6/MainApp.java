package io.github.futurewl.spring.framework.beans.ioc.demo6;
...
public class MainApp {
    public static void main(String[] args) {
        AbstractApplicationContext context = new ClassPathXmlApplicationContext("beans/ioc/IocBeans6.xml");
